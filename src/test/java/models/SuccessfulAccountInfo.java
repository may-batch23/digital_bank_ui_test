...
public class SuccessfulAccountInfo {
    ...
    public SuccessfulAccountInfo(String checkingAccountType, String accountOwnership, String accountName, double initialDepositAmount) {
